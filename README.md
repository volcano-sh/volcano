...
```
kubectl apply -f https://raw.githubusercontent.com/volcano-sh/volcano/release-2.0/installer/volcano-development.yaml
```
...
```bash
make TAG=v2.0.0 generate-yaml
kubectl create -f _output/release/volcano-monitoring-v2.0.0.yaml
```
