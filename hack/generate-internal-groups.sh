...
(
  ...
  cd "$(dirname "${0}")"
  GO111MODULE=on go install k8s.io/code-generator/cmd/{defaulter-gen@release-1.29,conversion-gen@release-1.29,client-gen@release-1.29,lister-gen@release-1.29,informer-gen@release-1.29,deepcopy-gen@release-1.29,openapi-gen@release-1.29}
)
