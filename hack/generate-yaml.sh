...
tail -n +3 ${VK_ROOT}/config/crd/bases/nodeinfo.volcano.sh_numatopoes.yaml > ${HELM_CRD_DIR}/bases/nodeinfo.volcano.sh_numatopoes.yaml
# sync v1beta1
...
tail -n +3 ${VK_ROOT}/config/crd/v1beta1/nodeinfo.volcano.sh_numatopoes.yaml > ${HELM_CRD_DIR}/v1beta1/nodeinfo.volcano.sh_numatopoes.yaml
...
${HELM_BIN_DIR}/helm template ${VK_ROOT}/installer/helm/chart/volcano --namespace volcano-system \
      ...
      -s templates/nodeinfo_v1alpha1_numatopo.yaml \
      >> ${DEPLOYMENT_FILE}
