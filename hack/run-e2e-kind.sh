...
"ALL")
    echo "Running e2e..."
    KUBECONFIG=${KUBECONFIG} ginkgo -v -r --nodes=4 --compilers=4 --randomize-all --randomize-suites --fail-on-pending --cover --trace --race ./test/e2e/jobp/
    KUBECONFIG=${KUBECONFIG} ginkgo -v -r ./test/e2e/jobseq/
    KUBECONFIG=${KUBECONFIG} ginkgo -v -r ./test/e2e/schedulingbase/
    KUBECONFIG=${KUBECONFIG} ginkgo -v -r ./test/e2e/schedulingaction/
    KUBECONFIG=${KUBECONFIG} ginkgo -v -r ./test/e2e/vcctl/
    ;;
"JOBP")
...
"STRESS")
    ...
    KUBECONFIG=${KUBECONFIG} ginkgo -v -r ./test/e2e/stress/
    ;;
esac
