...
"ALL")
    echo "Running e2e..."
    KUBECONFIG=${KUBECONFIG} ginkgo -r --nodes=4 --compilers=4 --randomizeAllSpecs --randomizeSuites --failOnPending --cover --trace --race --progress ./test/e2e/jobp/
    KUBECONFIG=${KUBECONFIG} ginkgo -r --progress ./test/e2e/jobseq/
    KUBECONFIG=${KUBECONFIG} ginkgo -r --progress ./test/e2e/schedulingbase/
    KUBECONFIG=${KUBECONFIG} ginkgo -r --progress ./test/e2e/schedulingaction/
    KUBECONFIG=${KUBECONFIG} ginkgo -r --progress ./test/e2e/vcctl/
    ;;
"JOBP")
...
"STRESS")
    ...
    KUBECONFIG=${KUBECONFIG} ginkgo -r --progress ./test/e2e/stress/
    ;;
esac
