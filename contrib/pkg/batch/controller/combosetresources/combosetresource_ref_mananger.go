...
type RefManager interface {
	...
	//Tag the owner
	AddTag(owner *qjobv1.ComboSetResource, getTag func() string) error

	//check whether ownee is a member of owner
	BelongTo(owner *qjobv1.ComboSetResource, ownee runtime.Object) bool

	//mark the ownee to be a member of owner
	AddReference(owner *qjobv1.ComboSetResource, ownee runtime.Object) error
}
...
func (rm *RefByLabel) AddTag(owner *qjobv1.ComboSetResource, getTag func() string) error {
...
func (rm *RefByLabel) BelongTo(owner *qjobv1.ComboSetResource, ownee runtime.Object) bool {
...
func (rm *RefByLabel) AddReference(owner *qjobv1.ComboSetResource, ownee runtime.Object) error {
