...
const (
	ComboSetGroup    string = qjobv1.GroupName
	ComboSetVersion  string = "v1"
	FullComboSetName string = qjobv1.ComboSetPlural + "." + ComboSetGroup
)
...
func CreateComboSet(clientset apiextclient.Interface) (*apiextv1beta1.CustomResourceDefinition, error) {
	qjob := &apiextv1beta1.CustomResourceDefinition{
		ObjectMeta: metav1.ObjectMeta{
			Name: FullComboSetName,
		},
		Spec: apiextv1beta1.CustomResourceDefinitionSpec{
			Group:   ComboSetGroup,
			Version: ComboSetVersion,
			Scope:   apiextv1beta1.NamespaceScoped,
			Names: apiextv1beta1.CustomResourceDefinitionNames{
				Plural: qjobv1.ComboSetPlural,
				Kind:   reflect.TypeOf(qjobv1.ComboSet{}).Name(),
			},
		},
	}
	...
	err = wait.Poll(500*time.Millisecond, 60*time.Second, func() (bool, error) {
		qjob, err = clientset.ApiextensionsV1beta1().CustomResourceDefinitions().Get(FullComboSetName, metav1.GetOptions{})
		if err != nil {
			return false, err
		}
	...
	if err != nil {
		deleteErr := clientset.ApiextensionsV1beta1().CustomResourceDefinitions().Delete(FullComboSetName, nil)
		if deleteErr != nil {
