...
[the sample file of JobFlow](https://github.com/volcano-sh/volcano/blob/master/example/jobflow/JobFlow.yaml)
...
| `metadata`   | [`Metadata`](#metadata-1) | Y        |                            | Information about the JobTemplate resource.              |
...
You can view [the sample file of JobTemplate](https://github.com/volcano-sh/volcano/blob/master/example/jobflow/JobTemplate.yaml)
