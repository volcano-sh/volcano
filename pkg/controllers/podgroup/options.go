...
func AddFlags(fs *pflag.FlagSet, o *Options) {
	...
	fs.StringArrayVar(&o.InheritPodAnnotationPrefixes, "inherit-pod-annotation-prefixes", []string{"volcano.sh/"}, "Pod's annotations prefixes which will be inherited to PodGroup; by default, with 'volcano.sh/' prefix will be inherited to PodGroup")
	...
	fs.StringArrayVar(&o.InheritPodLabelPrefixes, "inherit-pod-label-prefixes", []string{"volcano.sh/"}, "Pod's labels prefixes which will be inherited to PodGroup; by default, with 'volcano.sh/' prefix will be inherited to PodGroup")
}
