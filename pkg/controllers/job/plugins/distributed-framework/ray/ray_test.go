...
func TestRayPlugin(t *testing.T) {
	...
	for i, testcase := range testcases {
		t.Run(testcase.Name, func(t *testing.T) {
			...
			svc, createErr := fakeClient.CoreV1().Services(testcase.Job.Namespace).Get(context.TODO(), testcase.Job.Name, metav1.GetOptions{})
			if createErr != nil {
			...
			_, deleteErr := fakeClient.CoreV1().Services(testcase.Job.Namespace).Get(context.TODO(), testcase.Job.Name, metav1.GetOptions{})
			if deleteErr == nil {
