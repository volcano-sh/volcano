...
func (as *abortedState) Execute(action vcbusv1.Action) error {
	switch action {
	case vcbusv1.ResumeJobAction:
		return KillJob(as.job, PodRetainPhaseSoft, func(status *vcbatchv1.JobStatus) bool {
