...
func (hn *hyperNodeController) Initialize(opt *framework.ControllerOption) error {
	...
	hn.discoveryManager = discovery.NewManager(configLoader, hn.configMapQueue)
