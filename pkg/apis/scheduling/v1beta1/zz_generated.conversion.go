...
func RegisterConversions(s *runtime.Scheme) error {
	if err := s.AddGeneratedConversionFunc((*HierarchyAttr)(nil), (*scheduling.HierarchyAttr)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_HierarchyAttr_To_scheduling_HierarchyAttr(a.(*HierarchyAttr), b.(*scheduling.HierarchyAttr), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*scheduling.HierarchyAttr)(nil), (*HierarchyAttr)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_scheduling_HierarchyAttr_To_v1beta1_HierarchyAttr(a.(*scheduling.HierarchyAttr), b.(*HierarchyAttr), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*Parameter)(nil), (*scheduling.Parameter)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_Parameter_To_scheduling_Parameter(a.(*Parameter), b.(*scheduling.Parameter), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*scheduling.Parameter)(nil), (*Parameter)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_scheduling_Parameter_To_v1beta1_Parameter(a.(*scheduling.Parameter), b.(*Parameter), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1beta1_HierarchyAttr_To_scheduling_HierarchyAttr(in *HierarchyAttr, out *scheduling.HierarchyAttr, s conversion.Scope) error {
	out.Name = in.Name
	if err := Convert_v1beta1_Parameter_To_scheduling_Parameter(&in.Parameters, &out.Parameters, s); err != nil {
		return err
	}
	return nil
}

// Convert_v1beta1_HierarchyAttr_To_scheduling_HierarchyAttr is an autogenerated conversion function.
func Convert_v1beta1_HierarchyAttr_To_scheduling_HierarchyAttr(in *HierarchyAttr, out *scheduling.HierarchyAttr, s conversion.Scope) error {
	return autoConvert_v1beta1_HierarchyAttr_To_scheduling_HierarchyAttr(in, out, s)
}

func autoConvert_scheduling_HierarchyAttr_To_v1beta1_HierarchyAttr(in *scheduling.HierarchyAttr, out *HierarchyAttr, s conversion.Scope) error {
	out.Name = in.Name
	if err := Convert_scheduling_Parameter_To_v1beta1_Parameter(&in.Parameters, &out.Parameters, s); err != nil {
		return err
	}
	return nil
}

// Convert_scheduling_HierarchyAttr_To_v1beta1_HierarchyAttr is an autogenerated conversion function.
func Convert_scheduling_HierarchyAttr_To_v1beta1_HierarchyAttr(in *scheduling.HierarchyAttr, out *HierarchyAttr, s conversion.Scope) error {
	return autoConvert_scheduling_HierarchyAttr_To_v1beta1_HierarchyAttr(in, out, s)
}

func autoConvert_v1beta1_Parameter_To_scheduling_Parameter(in *Parameter, out *scheduling.Parameter, s conversion.Scope) error {
...
// Convert_v1beta1_Parameter_To_scheduling_Parameter is an autogenerated conversion function.
func Convert_v1beta1_Parameter_To_scheduling_Parameter(in *Parameter, out *scheduling.Parameter, s conversion.Scope) error {
	return autoConvert_v1beta1_Parameter_To_scheduling_Parameter(in, out, s)
}

func autoConvert_scheduling_Parameter_To_v1beta1_Parameter(in *scheduling.Parameter, out *Parameter, s conversion.Scope) error {
	out.Weight = in.Weight
	out.Capability = *(*v1.ResourceList)(unsafe.Pointer(&in.Capability))
	out.Reclaimable = (*bool)(unsafe.Pointer(in.Reclaimable))
	return nil
...
// Convert_scheduling_Parameter_To_v1beta1_Parameter is an autogenerated conversion function.
func Convert_scheduling_Parameter_To_v1beta1_Parameter(in *scheduling.Parameter, out *Parameter, s conversion.Scope) error {
	return autoConvert_scheduling_Parameter_To_v1beta1_Parameter(in, out, s)
}
...
func autoConvert_v1beta1_QueueSpec_To_scheduling_QueueSpec(in *QueueSpec, out *scheduling.QueueSpec, s conversion.Scope) error {
	...
	out.Capability = *(*v1.ResourceList)(unsafe.Pointer(&in.Capability))
	out.Reclaimable = (*bool)(unsafe.Pointer(in.Reclaimable))
	out.Hierarchy = *(*[]scheduling.HierarchyAttr)(unsafe.Pointer(&in.Hierarchy))
	return nil
}
...
func autoConvert_scheduling_QueueSpec_To_v1beta1_QueueSpec(in *scheduling.QueueSpec, out *QueueSpec, s conversion.Scope) error {
	...
	out.Reclaimable = (*bool)(unsafe.Pointer(in.Reclaimable))
	out.Hierarchy = *(*[]HierarchyAttr)(unsafe.Pointer(&in.Hierarchy))
	return nil
}
