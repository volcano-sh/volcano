...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *QueueRequest) DeepCopyInto(out *QueueRequest) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new QueueRequest.
func (in *QueueRequest) DeepCopy() *QueueRequest {
	if in == nil {
		return nil
	}
	out := new(QueueRequest)
	in.DeepCopyInto(out)
	return out
}
