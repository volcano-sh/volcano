...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PodGroupState) DeepCopyInto(out *PodGroupState) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PodGroupState.
func (in *PodGroupState) DeepCopy() *PodGroupState {
	if in == nil {
		return nil
	}
	out := new(PodGroupState)
	in.DeepCopyInto(out)
	return out
}
