...
import (
	...
	internalinterfaces "hpw.cloud/volcano/pkg/client/informers/internalversion/internalinterfaces"
	internalversion "hpw.cloud/volcano/pkg/client/listers/v1alpha1/internalversion"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.V1alpha1().Jobs(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.V1alpha1().Jobs(namespace).Watch(options)
			},
		},
		&v1alpha1.Job{},
		resyncPeriod,
...
func (f *jobInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&v1alpha1.Job{}, f.defaultInformer)
}
