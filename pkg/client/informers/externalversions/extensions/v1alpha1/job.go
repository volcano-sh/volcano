...
import (
	...
	v1alpha1 "github.com/kubernetes-incubator/kube-arbitrator/pkg/client/listers/extensions/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ExtensionsV1alpha1().Jobs(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ExtensionsV1alpha1().Jobs(namespace).Watch(options)
			},
		},
		&extensions_v1alpha1.Job{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *jobInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&extensions_v1alpha1.Job{}, f.defaultInformer)
}
