...
// RegisterBindHandler registers the passed bind handler to the cache
func (ssn *Session) RegisterBindHandler(name string, handler interface{}) {
	ssn.cache.RegisterBindHandler(name, handler)
}
