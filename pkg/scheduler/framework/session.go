...
type Session struct {
	...
	PriorityClassInfo *api.PriorityClassInfo
	...
	queueScoreOrderFns map[string]api.ScoreFn
...
func openSession(cache cache.Cache) *Session {
	...
	ssn.PriorityClassInfo = snapshot.PriorityClassInfo
