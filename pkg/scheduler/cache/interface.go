...
type Cache interface {
	...
	// RegisterBindHandler registers a new bind handler if it does not exist
	RegisterBindHandler(name string, handler interface{})
}
...
type PreBinder interface {
	...
	// RollBack is called when the pre-bind or bind fails.
	RollBack(ctx context.Context, bindCtx *BindContext)
}
