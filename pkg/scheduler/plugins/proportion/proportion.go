...
func (pp *proportionPlugin) OnSessionOpen(ssn *framework.Session) {
	...
	ssn.AddParallelAllocatableFn(pp.Name(), func(ctx context.Context, cycleState *k8sframework.CycleState, queue *api.QueueInfo, candidate *api.TaskInfo) bool {
	...
	ssn.AddInitCycleStateFn(pp.Name(), func(ctx context.Context, cycleState *k8sframework.CycleState) error {
		...
		cycleState.Write(proportionStateKey, state)
		return nil
	})
