...
func TestCapacityHints(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "non-consuming PodGroup deletion in rejection path is skipped", hintFn: podGroupHint, oldObj: podGroup("child", scheduling.PodGroupPending), want: unschedulable.HintSkip},
