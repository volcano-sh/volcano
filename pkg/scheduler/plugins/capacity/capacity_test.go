	...
	tests := []uthelper.TestCommonStruct{
		{
			...
			Queues:    []*schedulingv1beta1.Queue{queue1, queue2, queue11, queue12},
			ExpectBindMap: map[string]string{
				"ns1/p1": "n1",
			},
			ExpectBindsNum: 1,
		...
		},
		{
			...
			Queues:    []*schedulingv1beta1.Queue{queue3, queue4, queue31, queue32},
			ExpectBindMap: map[string]string{
				"ns1/p3": "n1",
				"ns1/p4": "n1",
			},
		...
		},
		{
			...
			Queues:    []*schedulingv1beta1.Queue{queue3, queue31, queue32, queue4},
			ExpectPipeLined: map[string][]string{
				"ns1/pg6": {"n1"},
			},
