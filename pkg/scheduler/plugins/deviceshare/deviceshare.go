...
const (
    ...
    KnowGeometriesCMName = "deviceshare.KnowGeometriesCMName"
    KnowGeometriesCMNamespace = "deviceshare.KnowGeometriesCMNamespace"
)
...
func enablePredicate(dsp *deviceSharePlugin) {
    ...
    KnowGeometriesCMName, ok := args[KnowGeometriesCMName].(string)
    if !ok {
        KnowGeometriesCMName = "volcano-vgpu-device-config"
    }
    KnowGeometriesCMNamespace, ok := args[KnowGeometriesCMNamespace].(string)
    if !ok {
        KnowGeometriesCMName = "default"
    }
    config.InitDevicesConfig(KnowGeometriesCMName, KnowGeometriesCMNamespace)
}
