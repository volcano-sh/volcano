...
func TestArguments(t *testing.T) {
	...
	arguments := framework.Arguments{
		...
		"sra.retention.weight":                   3,
		"sra.retention.nvidia.com/t4":            1,
		"sra.retention.nvidia.com/a10":           2,
		"sra.proportional.nvidia.com/t4.cpu":     3,
		"sra.proportional.nvidia.com/t4.memory":  6,
		"sra.proportional.nvidia.com/a10.cpu":    4,
		"sra.proportional.nvidia.com/a10.memory": 8,
	}
	...
	if rsf.sraPolicy != RetentionPolicy {
		t.Errorf("sra.policy should be retention, but not %s", rsf.sraPolicy)
	}

	retention := rsf.retention
	...
	tests := []struct {
	...
	}{
		{
			...
			arguments: framework.Arguments{
				...
				"sra.retention.nvidia.com/a10": 3,
			},
			expected: map[string]map[string]float64{
				"c1/p1": {
					"n1": 500,
