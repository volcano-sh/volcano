...
const (
	...
	// LeaderWorkerSetSupport enables cache and operate LeaderWorkerSet
	LeaderWorkerSetSupport featuregate.Feature = "LeaderWorkerSetSupport"
)
...
var defaultVolcanoFeatureGates = map[featuregate.Feature]featuregate.FeatureSpec{
	...
	LeaderWorkerSetSupport: {Default: false, PreRelease: featuregate.Alpha},
}
