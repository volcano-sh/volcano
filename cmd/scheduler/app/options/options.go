...
type ServerOption struct {
	...
	WaitForHandlersSyncedBeforeStart bool
}
...
func (s *ServerOption) AddFlags(fs *pflag.FlagSet) {
	...
	fs.BoolVar(&s.WaitForHandlersSyncedBeforeStart, "wait-handlers-synced", false, "Wait for handlers synced before starting to schedule, it's false by default")
}
