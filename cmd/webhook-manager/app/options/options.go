...
const (
	...
	defaultQPS                  = 50.0
	defaultBurst                = 100
	defaultEnabledAdmission     = "/jobs/mutate,/jobs/validate,/namespacequeues/validate,/podgroups/mutate,/podgroups/validate,/pods/validate,/pods/mutate,/queues/mutate,/queues/validate"
