...
type AutoscalingV1alpha1Interface interface {
	...
	VerticalQueueAutoscalersGetter
}

// AutoscalingV1alpha1Client is used to interact with features provided by the autoscaling.volcano.sh group.
type AutoscalingV1alpha1Client struct {
	restClient rest.Interface
}

func (c *AutoscalingV1alpha1Client) VerticalQueueAutoscalers() VerticalQueueAutoscalerInterface {
	return newVerticalQueueAutoscalers(c)
}
