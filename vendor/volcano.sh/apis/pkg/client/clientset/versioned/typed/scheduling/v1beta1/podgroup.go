...
func (c *podGroups) Get(name string, options v1.GetOptions) (result *v1beta1.PodGroup, err error) {
...
func (c *podGroups) List(opts v1.ListOptions) (result *v1beta1.PodGroupList, err error) {
...
func (c *podGroups) Create(podGroup *v1beta1.PodGroup) (result *v1beta1.PodGroup, err error) {
	result = &v1beta1.PodGroup{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("podgroups").
...
func (c *podGroups) Update(podGroup *v1beta1.PodGroup) (result *v1beta1.PodGroup, err error) {
	result = &v1beta1.PodGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("podgroups").
...
func (c *podGroups) UpdateStatus(podGroup *v1beta1.PodGroup) (result *v1beta1.PodGroup, err error) {
	result = &v1beta1.PodGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("podgroups").
...
func (c *podGroups) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.PodGroup, err error) {
	result = &v1beta1.PodGroup{}
