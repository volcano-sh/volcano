...
var jobsResource = schema.GroupVersionResource{Group: "batch.volcano.sh", Version: "v1", Resource: "jobs"}

var jobsKind = schema.GroupVersionKind{Group: "batch.volcano.sh", Version: "v1", Kind: "Job"}
