...
import (
	...
	v1 "volcano.sh/apis/pkg/client/listers/bus/v1"
)
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.BusV1().Commands(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.BusV1().Commands(namespace).Watch(context.TODO(), options)
			},
		},
		&busv1.Command{},
		resyncPeriod,
...
func (f *commandInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&busv1.Command{}, f.defaultInformer)
}

func (f *commandInformer) Lister() v1.CommandLister {
	return v1.NewCommandLister(f.Informer().GetIndexer())
}
