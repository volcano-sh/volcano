...
- Improved information:
  + | Tasks     | Reason             | Message                                                                                                                                                                                                                        |
    ...
    | Task1     | **Schedulable**    | **pod in gang unschedulable: Pod ns1/task-1 can possibly be assgined to node1**                                                                                                                                                |
    | Task2     | **Schedulable**    | **pod in gang unschedulable: Pod ns1/task-2 can possibly be assgined to node2**                                                                                                                                                |
    | Task3     | **Schedulable**    | **pod in gang unschedulable: Pod ns1/task-3 can possibly be assgined to node3**                                                                                                                                                |
    | Task4     | Unschedulable      | **pod in gang unschedulable:** all nodes are unavailable: 1 plugin InterPodAffinity predicates failed node(s) didn't match pod affinity/anti-affinity, node(s) didn't match pod affinity rules, 2 node(s) resource fit failed. |
