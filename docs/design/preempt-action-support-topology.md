...
- `SimulateAllocatableFn`: Simulate the allocatable check for a node, plugins implement this function to verify if the node has enough resources to schedule the task while maintaining topology constraints
