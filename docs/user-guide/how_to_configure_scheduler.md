...
| 8   | overcommit    | * overcommit-factor<br/> * max-queue-overcommit-factor                                                                                                                                                                                                                                                                                           | * jobEnqueueableFn<br/> * jobEnqueuedFn                                                                                                 | Set the available resource as the given times of the whole resource of the cluster. `max-queue-overcommit-factor` caps Queue-scoped admission factors when the `QueueScopedOvercommit` feature gate is enabled. |
