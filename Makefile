...
update-development-yaml:
	make generate-yaml TAG=v1.12.1 RELEASE_DIR=installer
	mv installer/volcano-v1.12.1.yaml installer/volcano-development.yaml
	mv installer/volcano-agent-v1.12.1.yaml installer/volcano-agent-development.yaml
