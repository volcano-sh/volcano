...
manifests: controller-gen
	$(CONTROLLER_GEN) $(CRD_OPTIONS) paths="./vendor/volcano.sh/apis/pkg/apis/scheduling/v1beta1;./vendor/volcano.sh/apis/pkg/apis/batch/v1alpha1;./vendor/volcano.sh/apis/pkg/apis/bus/v1alpha1;./vendor/volcano.sh/apis/pkg/apis/nodeinfo/v1alpha1;./vendor/volcano.sh/apis/pkg/apis/scheduling/v1;./vendor/volcano.sh/apis/pkg/apis/batch/v1;./vendor/volcano.sh/apis/pkg/apis/bus/v1" output:crd:artifacts:config=config/crd/bases
	$(CONTROLLER_GEN) "crd:crdVersions=v1beta1" paths="./vendor/volcano.sh/apis/pkg/apis/scheduling/v1beta1;./vendor/volcano.sh/apis/pkg/apis/batch/v1alpha1;./vendor/volcano.sh/apis/pkg/apis/bus/v1alpha1;./vendor/volcano.sh/apis/pkg/apis/nodeinfo/v1alpha1;./vendor/volcano.sh/apis/pkg/apis/scheduling/v1;./vendor/volcano.sh/apis/pkg/apis/batch/v1;./vendor/volcano.sh/apis/pkg/apis/bus/v1" output:crd:artifacts:config=config/crd/v1beta1
