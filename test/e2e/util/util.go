...
func dumpPods(ctx *TestContext, namespace, path string) error {
...
func dumpPodGroups(ctx *TestContext, namespace, path string) error {
	var pgs *schedulingv1beta1.PodGroupList
	var err error
...
func dumpVCJobs(ctx *TestContext, namespace, path string) error {
	var jobs *batchv1alpha1.JobList
	var err error
	jobs, err = ctx.Vcclient.BatchV1alpha1().Jobs(namespace).List(context.TODO(), metav1.ListOptions{})
	if err != nil {
...
func dumpVCronJobs(ctx *TestContext, namespace, path string) error {
	var cronjobs *batchv1alpha1.CronJobList
	var err error
	cronjobs, err = ctx.Vcclient.BatchV1alpha1().CronJobs(namespace).List(context.TODO(), metav1.ListOptions{})
	if err != nil {
...
func dumpK8sJobs(ctx *TestContext, namespace, path string) error {
	var jobs *batchv1.JobList
	var err error
	jobs, err = ctx.Kubeclient.BatchV1().Jobs(namespace).List(context.TODO(), metav1.ListOptions{})
	if err != nil {
...
func dumpK8sCronJobs(ctx *TestContext, namespace, path string) error {
	var cronjobs *batchv1.CronJobList
	var err error
	cronjobs, err = ctx.Kubeclient.BatchV1().CronJobs(namespace).List(context.TODO(), metav1.ListOptions{})
	if err != nil {
...
func dumpDeployments(ctx *TestContext, namespace, path string) error {
	var deployments *appsv1.DeploymentList
	var err error
	deployments, err = ctx.Kubeclient.AppsV1().Deployments(namespace).List(context.TODO(), metav1.ListOptions{})
	if err != nil {
...
func dumpStatefulSets(ctx *TestContext, namespace, path string) error {
	var statefulsets *appsv1.StatefulSetList
	var err error
	statefulsets, err = ctx.Kubeclient.AppsV1().StatefulSets(namespace).List(context.TODO(), metav1.ListOptions{})
	if err != nil {
...
func writeResourceToFile(obj interface{}, filePath string) error {
