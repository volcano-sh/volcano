...
type CronJobSpecApplyConfiguration struct {
	...
	ConcurrencyPolicy *batchv1alpha1.ConcurrencyPolicy `json:"concurrencyPolicy,omitempty"`
...
func (b *CronJobSpecApplyConfiguration) WithConcurrencyPolicy(value batchv1alpha1.ConcurrencyPolicy) *CronJobSpecApplyConfiguration {
