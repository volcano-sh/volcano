...
type CronJobLister interface {
	...
	List(selector labels.Selector) (ret []*batchv1alpha1.CronJob, err error)
...
type cronJobLister struct {
	listers.ResourceIndexer[*batchv1alpha1.CronJob]
}

// NewCronJobLister returns a new CronJobLister.
func NewCronJobLister(indexer cache.Indexer) CronJobLister {
	return &cronJobLister{listers.New[*batchv1alpha1.CronJob](indexer, batchv1alpha1.Resource("cronjob"))}
}

// CronJobs returns an object that can list and get CronJobs.
func (s *cronJobLister) CronJobs(namespace string) CronJobNamespaceLister {
	return cronJobNamespaceLister{listers.NewNamespaced[*batchv1alpha1.CronJob](s.ResourceIndexer, namespace)}
}
...
type CronJobNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*batchv1alpha1.CronJob, error)
