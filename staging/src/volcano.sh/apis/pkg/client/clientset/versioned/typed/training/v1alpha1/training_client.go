...
// TrainingV1alpha1Client is used to interact with features provided by the training.volcano.sh group.
type TrainingV1alpha1Client struct {
	restClient rest.Interface
}

func (c *TrainingV1alpha1Client) HyperJobs(namespace string) HyperJobInterface {
...
// NewForConfigAndClient creates a new TrainingV1alpha1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*TrainingV1alpha1Client, error) {
	config := *c
	setConfigDefaults(&config)
...
func setConfigDefaults(config *rest.Config) {
	gv := trainingv1alpha1.SchemeGroupVersion
