...
func autoConvert_v1beta1_QueueSpec_To_scheduling_QueueSpec(in *QueueSpec, out *scheduling.QueueSpec, s conversion.Scope) error {
	...
	if in.DRA != nil {
		...
		*out = new(scheduling.DRAQuota)
		if err := Convert_v1beta1_DRAQuota_To_scheduling_DRAQuota(*in, *out, s); err != nil {
			return err
		}
	} else {
		out.DRA = nil
...
func autoConvert_scheduling_QueueSpec_To_v1beta1_QueueSpec(in *scheduling.QueueSpec, out *QueueSpec, s conversion.Scope) error {
	...
	if in.DRA != nil {
		in, out := &in.DRA, &out.DRA
		*out = new(DRAQuota)
		if err := Convert_scheduling_DRAQuota_To_v1beta1_DRAQuota(*in, *out, s); err != nil {
			return err
		}
	} else {
		out.DRA = nil
...
func autoConvert_v1beta1_DRAQuota_To_scheduling_DRAQuota(in *DRAQuota, out *scheduling.DRAQuota, s conversion.Scope) error {
	if in.Capability != nil {
		in, out := &in.Capability, &out.Capability
		*out = make(map[string]scheduling.DRAResourceQuota, len(*in))
		for key, val := range *in {
			newVal := new(scheduling.DRAResourceQuota)
			if err := Convert_v1beta1_DRAResourceQuota_To_scheduling_DRAResourceQuota(&val, newVal, s); err != nil {
				return err
			}
			(*out)[key] = *newVal
		}
...
func Convert_v1beta1_DRAQuota_To_scheduling_DRAQuota(in *DRAQuota, out *scheduling.DRAQuota, s conversion.Scope) error {
	return autoConvert_v1beta1_DRAQuota_To_scheduling_DRAQuota(in, out, s)
}

func autoConvert_scheduling_DRAQuota_To_v1beta1_DRAQuota(in *scheduling.DRAQuota, out *DRAQuota, s conversion.Scope) error {
	if in.Capability != nil {
		in, out := &in.Capability, &out.Capability
		*out = make(map[string]DRAResourceQuota, len(*in))
		for key, val := range *in {
			newVal := new(DRAResourceQuota)
			if err := Convert_scheduling_DRAResourceQuota_To_v1beta1_DRAResourceQuota(&val, newVal, s); err != nil {
				return err
			}
			(*out)[key] = *newVal
		}
...
func Convert_scheduling_DRAQuota_To_v1beta1_DRAQuota(in *scheduling.DRAQuota, out *DRAQuota, s conversion.Scope) error {
	return autoConvert_scheduling_DRAQuota_To_v1beta1_DRAQuota(in, out, s)
}

func autoConvert_v1beta1_DRAResourceQuota_To_scheduling_DRAResourceQuota(in *DRAResourceQuota, out *scheduling.DRAResourceQuota, s conversion.Scope) error {
	out.Count = in.Count
	out.Capacity = *(*map[string]resource.Quantity)(unsafe.Pointer(&in.Capacity))
	return nil
}

func Convert_v1beta1_DRAResourceQuota_To_scheduling_DRAResourceQuota(in *DRAResourceQuota, out *scheduling.DRAResourceQuota, s conversion.Scope) error {
	return autoConvert_v1beta1_DRAResourceQuota_To_scheduling_DRAResourceQuota(in, out, s)
}

func autoConvert_scheduling_DRAResourceQuota_To_v1beta1_DRAResourceQuota(in *scheduling.DRAResourceQuota, out *DRAResourceQuota, s conversion.Scope) error {
	out.Count = in.Count
	out.Capacity = *(*map[string]resource.Quantity)(unsafe.Pointer(&in.Capacity))
	return nil
}

func Convert_scheduling_DRAResourceQuota_To_v1beta1_DRAResourceQuota(in *scheduling.DRAResourceQuota, out *DRAResourceQuota, s conversion.Scope) error {
	return autoConvert_scheduling_DRAResourceQuota_To_v1beta1_DRAResourceQuota(in, out, s)
}
