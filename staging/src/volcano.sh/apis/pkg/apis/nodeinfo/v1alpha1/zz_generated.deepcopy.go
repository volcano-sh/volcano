...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ContainerAllocation) DeepCopyInto(out *ContainerAllocation) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ContainerAllocation.
func (in *ContainerAllocation) DeepCopy() *ContainerAllocation {
	if in == nil {
		return nil
	}
	out := new(ContainerAllocation)
	in.DeepCopyInto(out)
	return out
}
...
func (in *NumatopoSpec) DeepCopyInto(out *NumatopoSpec) {
	*out = *in
	...
	if in.GPUDetail != nil {
		in, out := &in.GPUDetail, &out.GPUDetail
		*out = make(map[string]GPUInfo, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
...
func (in *PodAllocation) DeepCopyInto(out *PodAllocation) {
	*out = *in
	if in.ContainerAllocations != nil {
		in, out := &in.ContainerAllocations, &out.ContainerAllocations
		*out = make([]ContainerAllocation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
