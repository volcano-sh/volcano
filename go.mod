...
require (
	...
	volcano.sh/apis v0.0.0-20240907072250-cf31b32f1984
)

replace volcano.sh/apis v0.0.0-20240907072250-cf31b32f1984 => github.com/lowang-bh/apis v0.0.0-20240907072250-cf31b32f1984
