...
require (
	...
	volcano.sh/apis v0.0.0-20241026062332-74ae85db0bc5
)

replace volcano.sh/apis v0.0.0-20241026062332-74ae85db0bc5 => github.com/lowang-bh/apis v0.0.0-20241026062332-74ae85db0bc5
